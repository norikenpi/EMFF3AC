...
function histories = makeHistoriesMemory(param)
    ...
    histories.position_d_histories = zeros(int32(param.t/param.dt)+1, 3, param.N);
    ...
    %histories.c = zeros(int32(param.t/param.dt)+1, cell(1), param.N);
    %histories.v = zeros(int32(param.t/param.dt)+1, cell(1), param.N);
