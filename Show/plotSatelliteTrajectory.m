...
function [h_traj, h_force, h_mag, h_pair] = plotSatelliteTrajectory(histories, param, time_i, color, name, satellite_j)
    ...
    h_mag = quiver3(histories.position_histories(time_i, 1, satellite_j), histories.position_histories(time_i, 2, satellite_j), histories.position_histories(time_i, 3, satellite_j), histories.velocity_histories(time_i, 1, satellite_j)*param.velocity_arrow_scale, histories.velocity_histories(time_i, 2, satellite_j)*param.velocity_arrow_scale, histories.velocity_histories(time_i, 3, satellite_j)*param.velocity_arrow_scale);
    h_force.Color = 'green';
    h_mag.Color = 'red';
